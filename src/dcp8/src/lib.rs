...
/// the tree.
///
/// <div><img src="./images/cpu-benchmark.svg"
/// alt="Comparison of time vs elements" width="800"></div>
///
/// The following chart depicts memory usage against the number of elements in
/// the tree.
///
/// <div><img src="./images/memory-benchmark.svg"
/// alt="Comparison of memory vs elements" width="800"></div>
///
/// # Conclusion
///
